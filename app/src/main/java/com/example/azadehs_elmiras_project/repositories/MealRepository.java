...
//            Log.e("uuu",newMeal.getImageThumb());
            ...
            //Option - 1
            //sets the provided data to document with specified documentID
            //useful if you need customized document ID
            //if the document already exists, set() will overwrite it
//            DB.collection(COLLECTION_USERS)
//                    .document(newFriend.getName())
//                    .set(data)
                        ...
                        public void onSuccess(QuerySnapshot queryDocumentSnapshots) {
                            ...
                            if (queryDocumentSnapshots.isEmpty()){
                                ...
                                for(DocumentChange documentChange : queryDocumentSnapshots.getDocumentChanges()){
                                    ...
                                    Log.e("TAG", "onSuccess: currentMeal " + currentMeal.toString() );
                                }
...
//                                        case ADDED:
//                                            Log.e(TAG, "onEvent: New document added to firebase");
//                                        case MODIFIED:
//                                            Log.e(TAG, "onEvent: Existing document modified");
//                                        case REMOVED:
//                                            Log.e(TAG, "onEvent: Existing document deleted from firebase");
//                                    }
//                                }
//                            }
//
